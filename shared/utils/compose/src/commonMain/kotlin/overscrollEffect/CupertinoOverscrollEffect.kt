...
// https://github.com/JetBrains/compose-multiplatform-core/blob/jb-main/compose/foundation/foundation/src/uikitMain/kotlin/androidx/compose/foundation/cupertino/CupertinoOverscrollEffect.kt

// Need this, cuz CupertinoOverscrollEffect is iternal, not public ((
    ...
    override fun onPointerEvent(
        ...
        if (pass == PointerEventPass.Final) {
            if (pointerEvent.type == PointerEventType.Press) {
                ...
                pointersDown--
//                assert(pointersDown >= 0) { "pointersDown cannot be negative" } // modified: can't add this here
            }
        }
    }
